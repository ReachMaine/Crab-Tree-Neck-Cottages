...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-30321618-1']);
...
<style>
 .rates h3{font-size:1.4em; text-align:center;padding:0.2em;}
 .rates h4{font-size:1.2em; text-align:left;padding:0.9em;}
 .rates table{width:99%;margin:auto;margin-top:1em;margin-bottom:2em;}
 .rates caption{font-weight:bold;color:#003333;font-size:1.2em;padding-bottom:0.8em;}
 .rates td{padding:0.4em;font-size:0.95em;}
 .rates td,.rates th{text-align:left;}
 /*.rates .label{text-align:right;}*/
...
<br/><br/>The house has 3 bedrooms, one with a back stairway, and two bathrooms. It sleeps 7 to 10 people. The farmhouse kitchen is fully equipped and has a wood stove. The renovated dining room in the old summer kitchen opens on to a large flower filled deck and huge back yard. There are fields and woods all around. Wi-Fi available.</p>
	...
	$captions = array(
		3 => 'Blackberry Cottage',
		4 => 'Blackberry Cottage',
		6 => 'Porch, Blackberry Cottage',
		7 => 'Porch, Blackberry Cottage',
		2 => 'Porch, Blackberry Cottage',
		11 => 'Kitchen, Blackberry Cottage',
		12 => 'Living/Dining room, Blackberry Cottage',
		13 => 'Loft bedroom, Blackberry Cottage',
		5 => 'Downstairs bedroom, Blackberry Cottage',
		16 => 'Bunk room, Blackberry Cottage',
		1 => 'Bathroom, Blackberry Cottage',
		14 => 'From loft, Blackberry Cottage',
		15 => 'Loft, Blackberry Cottage',
		8 => 'Jellison Cove Stream',
		9 => 'Jellison Cove',
		10 => 'Wild roses at Jellison Cove',
		17 => 'Double bedroom, Blueberry Cottage',
		18 => 'Kitchen, Blueberry Cottage',
		19 => 'Loft bedroom, Blueberry Cottage',
		20 => 'Blueberry Cottage',
		21 => 'Pasture from porch, Blueberry Cottage',
		22 => 'Porch, Blueberry Cottage',
		23 => 'Blueberry Cottage',
		24 => 'Blueberry Cottage',
		25 => 'Living room, Blueberry Cottage',
		26 => 'Blueberry Cottage, September',
		27 => 'Cottage Rd. October',
		28 => 'Jellison Cove, October',
		29 => 'Morning glories, Blueberry Cottage, September',
		30 => 'Porch in September, Blueberry',
		31 => 'Sara in field, September',
		32 => 'Sunflowers in September, Blueberry',
		33 => 'Blackberries in bloom',
		34 => 'Horses in pasture, June',
		35 => 'Lupines at Blackberry Cottage, June',
		36 => 'Lupines at Jellison Cove, June',
		37 => 'Ducks and boat, Jellison Cove, June',
		38 => 'Traps, Jellison Cove, June',
		40 => 'New Porch, 1890\'s Farmhouse',
		41 => '1890\'s Farmhouse',
		42 => 'Land Trust bordering property, 1890\'s Farmhouse',
		43 => 'Dining room, 1890\'s Farmhouse',
		44 => 'Little barn and backyard, 1890\'s Farmhouse',
		45 => 'Addition, 1890\'s Farmhouse',
		46 => 'Master bedroom, 1890\'s Farmhouse',
		47 => 'Living room, 1890\'s Farmhouse',
		48 => 'Kitchen, 1890\'s Farmhouse',
		49 => 'Path to pasture, 1890\'s Farmhouse',
		50 => 'Bedroom, 1890\'s Farmhouse',
		51 => 'Double bedroom, 1890\'s Farmhouse'
		);
	foreach ($order as $i) {
		$i_nopad = $i;
	...
	$order = array(30,26,27,28,29,32,33,35,36,37);
	foreach ($order as $i) {
		$i_nopad = $i;
		$i = str_pad($i, 2, '0', STR_PAD_LEFT);
	?>
	...
	<div class="amenities">
		<ul>
			...
			<li>Coffee maker</li>
			<li>Microwave, toaster, refrigerator</li>
			<li>Cooking utensils and dishes provided</li>
			<li>Spacious porch for dining</li>
			<li>Fireplace type woodstove and wood</li>
...
the cost, with sales and lodging tax, is required for reservations,
the balance to be paid two weeks before arrival. The Farmhouse
requires an additional, <I>refundable</I> <B>security
damage deposit of $300</B>.
We accept checks and money orders, but not credit cards, except by
special arrangement. In case of a cancellation, deposits are not
refunded unless the reserved time is rented to another party, in
